...
public class StudentRepository {
	...
	public StudentPOJO updateStudent(StudentPOJO pojo) {
		...
		//just for not getteng an exception if user inset wrong record 
		//while updating we update only when record will exist , and we can check existance of record in search feature
		if (student!=null) {
